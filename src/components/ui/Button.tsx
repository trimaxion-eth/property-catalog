...
export function Button({
  ...
  return (
    <button
      type={type}
      className={`inline-flex items-center justify-center rounded-button px-4 py-2 text-sm font-medium transition focus-visible:ring-2 focus-visible:ring-brand-500/40 focus-visible:ring-offset-2 ${variantClasses[variant]} ${className}`}
      {...props}
    />
  );
}
